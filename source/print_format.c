...
// Pointer size in number of hex characters
    ...
    for (; *str; str++) {
        ...
        switch (*str++) {
            ...
            case 'P':
                ...
                flags |= FLAG_PREFIX | FLAG_ZERO | FLAG_POINTER;
                break;
            case 'r':
        ...
        // Print a number
            ...
            if (flags & FLAG_POINTER) {
                num = (i64)va_arg(arg, void*);
            } else {
                num = (i64)va_arg(arg, int);
            }
